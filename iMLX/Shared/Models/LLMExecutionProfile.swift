...
nonisolated struct LLMExecutionProfile: Identifiable, Codable, Hashable, Sendable {
    ...
    init(
        ...
        self.isBatteryLevelCoarse = PlatformProfilingSupport.isBatteryLevelCoarse
        self.batteryMeasurementKind = PlatformProfilingSupport.batteryMeasurementKind
    ...
    static let sessionMeasurementNotes = PlatformProfilingSupport.sessionMeasurementNotes
...
nonisolated struct LLMProfilingMeasurementMetadataExport: Codable, Hashable, Sendable {
    ...
    init(_ profile: LLMExecutionProfile?) {
        ...
        self.batteryMeasurementKind = profile?.batteryMeasurementKind
            ?? PlatformProfilingSupport.batteryMeasurementKind

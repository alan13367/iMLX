...
actor ModelDownloadService {
    static let backgroundSessionIdentifier =
        ModelDownloadPlatformConfiguration.backgroundSessionIdentifier
    ...
    private var platformAdditionalModelsProvider: PlatformAdditionalModelsProvider
    ...
    init(manifestService: ManifestService) {
        ...
        self.platformAdditionalModelsProvider = PlatformAdditionalModelsProvider()
    ...
    func refreshAdditionalModels() -> [ModelInfo] {
        let discovered = platformAdditionalModelsProvider.refreshAdditionalModels()
    ...
    func additionalModelsFolderURL() -> URL? {
        platformAdditionalModelsProvider.additionalModelsFolderURL()
    }
    ...
    func setAdditionalModelsFolder(_ folderURL: URL) throws {
        try platformAdditionalModelsProvider.setAdditionalModelsFolder(folderURL)
        additionalModelsByID = [:]
    }

    func clearAdditionalModelsFolder() {
        platformAdditionalModelsProvider.clearAdditionalModelsFolder()
        additionalModelsByID = [:]
    }

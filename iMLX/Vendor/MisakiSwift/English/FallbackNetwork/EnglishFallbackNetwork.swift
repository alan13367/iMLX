...
nonisolated final class EnglishFallbackNetwork {
  ...
  private static func loadConfig(british: Bool) -> BARTConfig? {
    ...
    guard let url = VendorResourceLocator.url(forResource: fileName, withExtension: "json"),
  ...
  private static func loadWeights(british: Bool) -> [String: MLXArray]? {
    ...
    guard let url = VendorResourceLocator.url(forResource: fileName, withExtension: "safetensors"),

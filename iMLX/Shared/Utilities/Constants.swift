    ...
    enum ModelRegistry {
        static let curatedModels: [ModelInfo] = [
            ...
            ModelInfo(
                ...
                huggingFaceId: "LiquidAI/LFM2.5-350M-MLX-bf16",
                parameterCount: "350M",
                quantization: "bf16",
                estimatedSizeGB: 0.7,
                minDeviceRAM: 8,
            ...
            ModelInfo(
                id: "lfm2.5-350m-8bit",
                displayName: "LFM2.5 350M 8-bit",
                huggingFaceId: "LiquidAI/LFM2.5-350M-MLX-8bit",
                parameterCount: "350M",
                quantization: "8-bit",
                estimatedSizeGB: 0.4,
                minDeviceRAM: 8,
            ...
            ModelInfo(
                ...
                huggingFaceId: "LiquidAI/LFM2.5-350M-MLX-6bit",
                parameterCount: "350M",
                quantization: "6-bit",
                estimatedSizeGB: 0.3,
                minDeviceRAM: 8,
            ...
            ModelInfo(
                id: "lfm2.5-350m-5bit",
                displayName: "LFM2.5 350M 5-bit",
                huggingFaceId: "LiquidAI/LFM2.5-350M-MLX-5bit",
                parameterCount: "350M",
                quantization: "5-bit",
                estimatedSizeGB: 0.3,
                minDeviceRAM: 8,
